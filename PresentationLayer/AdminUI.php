			...
			<td><strong><?php echo "Welcome " .$activeUser; ?> </strong></td>
							...
							<td>
								<label for="input_exit">
									<img src="Images/exit.png" style="max-height: 25px;">
					...
					<table id="tblMenu">
						<tbody>
							...
							<tr>
								...
								<td><input type="submit" name="deletebankcard" id="deletebankcard" value="Delete BankCard    "  /></td>
								<td></td>
								<td><input type="submit" name="Transfer" id="Transfer" value="Create CreditCard"/></td>
								
								<td></td>
								<td><input type="submit" name="Payment" id="Payments" value="Delete CreditCard"/></td>
								<td></td>
